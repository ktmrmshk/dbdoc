...
// DBTITLE 0,Remove bad records
// MAGIC %sql
// MAGIC DELETE FROM esg.gdelt_bronze
// MAGIC WHERE publishDate < '2019-01-01'
...
// MAGIC 
// MAGIC <img src="/files/shared_uploads/finserv/images/pagerank_esg.png" alt="logical_flow" width="500">
