...
# MAGIC %sql 
# MAGIC CREATE DATABASE IF NOT EXISTS ktmr_feature_store;
...
fs.create_feature_table(
    name="ktmr_feature_store.trip_pickup_features",
    keys=["zip", "ts"],
...
fs.create_feature_table(
    name="ktmr_feature_store.trip_dropoff_features",
    keys=["zip", "ts"],
...
# MAGIC %sql
# MAGIC describe extended ktmr_feature_store.trip_pickup_features
...
pickup_features_table = "ktmr_feature_store.trip_pickup_features"
dropoff_features_table = "ktmr_feature_store.trip_dropoff_features"
...
fs.log_model(
  ...
  registered_model_name="ktmr_taxi_example_fare_packaged"
)
